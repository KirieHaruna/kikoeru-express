...
ADD https://api.github.com/repos/KirieHaruna/kikoeru-quasar/git/refs/heads/unstable /tmp/version.json
RUN git clone -b ${FRONTEND_VERSION} https://github.com/KirieHaruna/kikoeru-quasar.git .
RUN npm ci
